...
const cronEndpoints = [
  ...
  '/api/admin/social/results/scheduled',
  '/api/admin/social/summary/morning',
  ...
  '/api/cron/premium-parlay-capture',
  '/api/cron/premium-parlay-settle',
  '/api/cron/premium-sgp-capture',
]
