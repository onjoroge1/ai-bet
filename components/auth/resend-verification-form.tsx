...
export function ResendVerificationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      logger.info('Email verification resend request', { tags: ['auth', 'email-verification'], data: { email } })
      ...
      setSuccess(true)
      logger.info('Email verification resend successful', { tags: ['auth', 'email-verification'], data: { email } })
    } catch (err) {
    ...
    return (
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300">We've sent you a new verification email</p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6 backdrop-blur-sm">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-4">Verification Email Sent!</h2>
            <p className="text-slate-300 mb-6">
              We've sent a new verification email to <span className="font-medium text-white">{email}</span>. 
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-300">Enter your email to receive a new verification link</p>
      </div>
      ...
      <Card className="bg-slate-800/50 border-slate-700 p-6 backdrop-blur-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <Button 
            ...
            disabled={isLoading}
            aria-label={isLoading ? "Sending verification email..." : "Send verification email"}
          >
